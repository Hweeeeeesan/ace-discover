...
export const PROFILE_DETAIL_LONG_EDGE = 1800;
export const PROFILE_DETAIL_WEBP_QUALITY = 84;
export const DISCOVERY_IMAGE_LONG_EDGE = 1400;
export const DISCOVERY_IMAGE_WEBP_QUALITY = 80;
